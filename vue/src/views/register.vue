...
export default {
  ...
  data(){
    ...
    {
      postRequest('register/',{user_id:this.name,user_password:this.password,user_Email:this.mail,user_phone:this.tel}).then(response=>{
        var is_t = response.data;
        if(is_t['register']==='False')
        {
